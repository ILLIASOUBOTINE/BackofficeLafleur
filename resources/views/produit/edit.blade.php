                   ...
                   @csrf
                    <div class="mb-4">
                        ...
                        <div class="mb-3">
                            ...
                            <select id="produit_unite" class="form-select" aria-label="Default select example" name="unite" type="text">
                        ...
                        <div class="mb-3">
                            ...
                            <div class="form-check">
                                ...
                                <label class="list-group-item d-flex flex-column mb-3" for="check_fleur_{{$fleur->idfleures}}">
                    ...
                    <div class="d-flex justify-content-between my-3">
                        ...
                        <a href="{{ route('produit.show') }}" class="btn btn-danger">Annuler</a>
                    </div>
                </form>
